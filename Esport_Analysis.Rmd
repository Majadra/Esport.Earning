...
```{r Earnings_Per_month, echo = FALSE}
...
### Did the coronavirus pandemic affect earnings and amount of tournaments?
...
```{r Coronavirus_effect_earnings, echo = FALSE, warning = FALSE}
...
```{r Street_Fighter_look,echo = TRUE, warning = FALSE,tidy = TRUE}
